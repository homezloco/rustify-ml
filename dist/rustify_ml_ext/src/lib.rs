...
#[pyfunction]
/// Auto-generated from Python hotspot `bpe_encode` at line 1 (100.00%): --function flag
pub fn bpe_encode(py: Python, text: String, merges: Vec<(i64, i64)>) -> PyResult<Vec<i64>> {
